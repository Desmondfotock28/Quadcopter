...
The control problem is to regulate the state to the origin. In discrete time NMPC formulation, this is done by considering the optimization problem at current state $ \mathrm{x}_k$ defined by:  
```math
\begin{align*}
